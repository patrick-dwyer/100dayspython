...
def main_logic(user_selection, water, coffee, milk, money):
    water_check = water
    milk_check = milk
    coffee_check = coffee
        ...
        def user_coin_input(user_selection):
            ...
            if user_money_sum >= drink_cost:
                ...
                if refund_money > money:
                    print("Sorry, there is not enough change in the machine to provide a proper refund.\nPlease consider using less money or come back again.")
                else:
